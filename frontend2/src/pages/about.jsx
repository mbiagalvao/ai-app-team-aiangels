    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <img src={catIcon} width={80} height={80} alt="Cat icon" />
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p style={{ lineHeight: '1.6', color: '#4b5563' }}>
           ...
           The information provided was retrieved from official, authority and thrustworthy sources, accompanied by a connection to the wide web.? We value 24/7 availability and global usage with multiple languages' integration.
           It was developed by AIAngels, a women-founded and woman-lead partnership. 
           ...
           At AIAngels, we believe in the transformative power of AI in daily living. We hope we made you believe as well.
          </p>
        </div>
